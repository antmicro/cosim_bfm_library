...
begin
     fork
         begin axi_read_address_channel(tid,addr,size,leng,burst); end
         begin axi_read_data_channel(tid,addr,size,leng,burst); end
     join
end
endtask
//------------------------------------------------------------------------------
...
begin
     fork
         begin axi_write_address_channel(tid,addr,size,leng,burst); end
         begin axi_write_data_channel(tid,addr,size,leng,burst); end
         begin axi_write_resp_channel(tid); end
     join
end
endtask
//------------------------------------------------------------------------------
